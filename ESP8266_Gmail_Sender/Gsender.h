...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "ZnJvbS5taWNyb2NvbnRyb2xsZXJAZ21haWwuY29t";
        const char* EMAILBASE64_PASSWORD = "SHRzNThuSCNUaw==";
        const char* FROM = "from.microcontroller@gmail.com";
